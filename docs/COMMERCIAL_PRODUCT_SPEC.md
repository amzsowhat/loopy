...
Natural is the protected default. Optional Extra character processing must remain downstream,
user-selectable and fully bypassable; it must never silently replace the Natural result.

## Product requirements

- Both modes must remain directly selectable in the plug-in.
- The primary flow must read source, range/shape, Generate, audition and export without embedding a
  numbered manual or decorative slogan in the UI.
